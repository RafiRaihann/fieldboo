...
<body>
    ...
    <header>
        <div class="container flex-row">
            ...
            <div class="right flex-center">
                <a href="logres/login.php" class="btn btn-secondary">Booking</a>
                <div class="menu-btn">
    ...
    <section id="hero" class="container flex-row">
        <div class="hero__content">
            ...
            <a href="logres/login.php" class="btn btn-primary">Login</a>
            <a href="logres/login.php" class="btn btn-primary">Daftar</a>
        </div>
        <div class="hero__img">
            <img src="landing/assets/Group.png" alt="">
        </div>
    </section>
            ...
            <div class="services">
                <div class="service">
                    <div class="service__icon">
                        <img src="landing/assets/field.png">
                    </div>
                ...
                <div class="service">
                    <div class="service__icon">
                        <img src="landing/assets/lab.png">
                    </div>
            ...
            <div class="projects">
                <div class="project">
                    <div class="project__img">
                        <img src="landing/assets/lapang.png" style="width: 500px;" alt="">
                    </div>
                ...
                <div class="project">
                    <div class="project__img">
                        <img src="landing/assets/jadwal.png" style="width: 500px;" alt="">
                    </div>
                    <div class="project__content">
                        <h3 class="project__category">Informasi</h3>
                        ...
                        <a href="#hero" class="btn btn-secondary">View Details</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="members">
            <div class="member">
                <div class="member__img">
                    <img src="landing/assets/G.png" alt="">
                </div>
            ...
            <div class="member">
                <div class="member__img">
                    <img src="landing/assets/Raka.png" style="width: 900px;" alt="">
                </div>
                <div class="member__content">
            ...
            <div class="member">
                <div class="member__img">
                    <img src="landing/assets/Rafi.png" style="width: 900px;" alt="">
                </div>
                <div class="member__content">
                    <h1>Rafi Raihan</h1>
            ...
            <div class="member">
                <div class="member__img">
                    <img src="landing/assets/Zain.jpg" alt="">
                </div>
                <div class="member__content">
